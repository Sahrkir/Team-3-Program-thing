...
public class addIncomeForm extends JFrame {
    ...
    private void initComponents() {
        ...
        incAdded.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                incAddedMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                incAddedMouseExited(evt);
            }
        });
    ...
    private void incAddedMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_incAddedMouseEntered
        incAdded.setBackground(Color.RED);
    }//GEN-LAST:event_incAddedMouseEntered

    private void incAddedMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_incAddedMouseExited
        incAdded.setBackground(new Color(240,240,240));
    }//GEN-LAST:event_incAddedMouseExited
    ...
    private void GreenMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_GreenMouseClicked
        if (evt.getSource() == Green) {
            ...
            addIncome_title.setForeground(new Color(240,240,240));
            ...
            input_Type.setForeground(new Color(240,240,240));
            input_Value.setForeground(new Color(240,240,240));
    ...
    private void WhiteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_WhiteMouseClicked
        if (evt.getSource() == White) {
            ...
            addIncome_title.setForeground(new Color(0,0,0));
    ...
    void readStyles() {
        try {
            ...
            addIncome_title.setForeground(new Color(c));
