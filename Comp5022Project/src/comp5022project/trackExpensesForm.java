 ...
 */
public class trackExpensesForm extends JFrame {

    User user;
    int coordinateX,coordinateY,mouseX,mouseY;
    
    public trackExpensesForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        trackExpense_title = new javax.swing.JLabel();
        ...
        trackExpense_title.setFont(new java.awt.Font("Felix Titling", 1, 24)); // NOI18N
        trackExpense_title.setForeground(new java.awt.Color(255, 255, 255));
        trackExpense_title.setText("Track your expenses");
        ...
        ContentLayout.setHorizontalGroup(
            ...
            .addGroup(ContentLayout.createSequentialGroup()
                ...
                .addGap(143, 143, 143)
                .addComponent(trackExpense_title)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(trackExpensesForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new trackExpensesForm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel trackExpense_title;
